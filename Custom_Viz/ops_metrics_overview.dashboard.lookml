- dashboard: operational_metrics__overview
  ...
  - name: ''
    type: text
    body_text: <a type="button" class="btn btn-info btn-lg btn-block" href="/embed/dashboards/10">Overview</a>
    row: 0
    col: 0
    width: 4
    height: 2
  - name: '1'
    type: text
    body_text: |-
      <a type="button" class="btn btn-secondary btn-lg btn-block" href="/embed/dashboards/11"
  ...
  - name: '2'
    ...
    body_text: |-
      <a type="button" class="btn btn-secondary btn-lg btn-block" href="/embed/dashboards/11"
      ><font color="#0079c1">Equality</font></a>
    row: 0
    col: 8
    width: 4
    height: 2
  - name: '3'
    ...
    body_text: |-
      <a type="button" class="btn btn-secondary btn-lg btn-block" href="/embed/dashboards/11"
      ><font color="#0079c1">Lives</font></a>
    row: 0
    col: 12
    width: 4
    height: 2
  - name: '4'
    ...
    body_text: |-
      <a type="button" class="btn btn-secondary btn-lg btn-block" href="/embed/dashboards/11"
      ><font color="#0079c1">Service</font></a>
    row: 0
    col: 16
    width: 4
    height: 2
  - name: '5'
    ...
    body_text: |-
      <a type="button" class="btn btn-secondary btn-lg btn-block" href="/embed/dashboards/11"
      ><font color="#0079c1">Stewardship</font></a>
    row: 0
    col: 20
    width: 4
    height: 2
